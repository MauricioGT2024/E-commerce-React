    ...
    return (
      <div className="max-w-[2000px] mx-auto px-4 sm:px-6 lg:px-8">
        <header className='mb-12 sm:mb-16 mt-8 sm:mt-12 flex flex-col justify-center text-center'>
          <h1 className='text-3xl sm:text-4xl lg:text-5xl font-bold mb-4'>Bienvenido a mi Tienda</h1>
                ...
                .map((product: Product) => (
                  ...
                  >
                    <div className='flex flex-col h-full'>
                      ...
                      >
                        <div className='relative pt-[100%] overflow-hidden rounded-t-lg bg-gray-100 dark:bg-gray-700'>
                          <img
