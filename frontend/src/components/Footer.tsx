// components/FooterPersonalizado.tsx
...
const Footer = () => {
  ...
  if (loading) return null; // 👈 Oculta el footer mientras carga

  return (
    <footer className="bg-gray-100 dark:bg-gray-900 text-gray-700 dark:text-gray-300 border-t border-gray-300 dark:border-gray-700">
      <div className="max-w-6xl mx-auto px-4 py-12 grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div>
          ...
          <p className="text-sm leading-relaxed">
            Compra los mejores productos al mejor precio. Envíos rápidos y
            soporte 24/7.
          </p>
        </div>
